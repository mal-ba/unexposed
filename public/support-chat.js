...
(function initSupportChat(){
 ...
 "ui": {
  "ko": {
   ...
   "a": [
    "스캔은 \"scan demo\" 섹션의 \"스캔하고 디자인 시작하기\" 버튼을 누르면 시작돼요. 카메라 권한을 허용하면 사진 촬영이나 5초 동영상 녹화를 할 수 있고, 카메라를 쓸 수 없으면 사진·동영상 파일을 업로드해도 돼요.",
    ...
    "지금은 테스트 결제로 연동되어 있어서, 실제 카드를 입력해도 진짜 돈은 빠져나가지 않아요. Free/Basic/Standard/Pro 플랜이 있고, 유료 플랜은 로그인 후 구독하기를 누르면 결제창으로 이동해요.",
    ...
    "신체 데이터(사진·키)는 로그인 후 \"신체 데이터 수집·보관\"에 직접 동의한 경우에만 저장돼요. 동의하지 않으면 화면에만 보이고 서버에는 저장되지 않고, 언제든 우측 상단 \"개인정보 설정\"에서 동의를 바꾸거나 저장된 데이터를 삭제할 수 있어요.",
  ...
  "en": {
   ...
   "sug": [
    "How do I scan?",
    "Will I really be charged?",
    "Google sign-in doesn't work",
    "Are my photos stored?"
   ],
   "a": [
    "To start scanning, press the \"Scan and start designing\" button in the scan demo section. Allow camera access to take a photo or record a 5-second video — if you can’t use the camera, you can upload a photo or video file instead.",
    ...
    "Payments are currently connected in test mode, so no real money is charged even if you enter a real card. There are Free/Basic/Standard/Pro plans; for paid plans, sign in and press Subscribe to go to checkout.",
    ...
    "Body data (photos, height) is stored only if you sign in and explicitly agree to \"Body data collection & storage.\" If you don’t agree, it’s only shown on screen and never saved to the server, and you can change your consent or delete stored data anytime in the privacy settings.",
  ...
  "ru": {
   ...
   "sug": [
    ...
    "С меня правда спишут деньги?",
    "Не работает вход через Google",
    "Сохраняются ли мои фото?"
   ],
   "a": [
    "Чтобы начать сканирование, нажмите кнопку «Сканировать и начать дизайн» в разделе scan demo. Разрешите доступ к камере, чтобы сделать фото или записать 5-секундное видео; если камера недоступна, можно загрузить файл фото или видео.",
    ...
    "Сейчас оплата подключена в тестовом режиме, поэтому даже при вводе настоящей карты деньги не списываются. Есть тарифы Free/Basic/Standard/Pro; для платных тарифов войдите в аккаунт и нажмите «Оформить подписку», чтобы перейти к оплате.",
    ...
    "Данные тела (фото, рост) сохраняются, только если вы вошли в аккаунт и сами согласились на «Сбор и хранение данных тела». Без согласия они лишь отображаются на экране и не сохраняются на сервере; согласие можно изменить или удалить сохранённые данные в любое время в настройках конфиденциальности.",
  ...
  "zh": {
   ...
   "a": [
    "在 scan demo 区域点击“扫描并开始设计”按钮即可开始扫描。允许相机权限后可以拍照或录制 5 秒视频；如果无法使用相机，也可以上传照片或视频文件。",
    "使用 Google 账号登录后即可订阅付费套餐或付款。在 KakaoTalk、Claude 应用等内置浏览器中，Google 出于安全政策会阻止登录，请点击页面顶部横幅中的“在外部浏览器中打开”，用 Chrome 或 Safari 打开。",
    "目前付款处于测试模式，即使输入真实银行卡也不会实际扣款。有 Free/Basic/Standard/Pro 套餐，付费套餐请登录后点击“订阅”进入付款页面。",
    ...
    "身体数据（照片、身高）只有在登录后亲自同意“身体数据收集与保存”时才会保存。不同意的话只会显示在屏幕上，不会保存到服务器；你也可以随时在隐私设置中更改同意或删除已保存的数据。",
  ...
  "ja": {
   ...
   "a": [
    "scan demoセクションの「スキャンしてデザインを始める」ボタンを押すとスキャンが始まります。カメラへのアクセスを許可すると写真撮影や5秒の動画録画ができ、カメラが使えない場合は写真・動画ファイルをアップロードしても大丈夫です。",
    ...
    "現在はテスト決済で連携しているため、実際のカードを入力しても本当にお金が引き落とされることはありません。Free/Basic/Standard/Proプランがあり、有料プランはログイン後に「購読する」を押すと決済画面に移動します。",
    ...
    "身体データ（写真・身長）は、ログイン後に「身体データの収集・保管」に自分で同意した場合にのみ保存されます。同意しなければ画面に表示されるだけでサーバーには保存されず、いつでもプライバシー設定で同意を変更したり、保存済みデータを削除したりできます。",
  ...
  "fr": {
   ...
   "sug": [
    ...
    "Vais-je vraiment être débité ?",
    "La connexion Google ne marche pas",
    "Mes photos sont-elles conservées ?"
   ],
   "a": [
    "Le scan démarre en appuyant sur le bouton « Scanner et commencer à créer » dans la section scan demo. En autorisant la caméra, vous pouvez prendre une photo ou filmer une vidéo de 5 secondes ; si la caméra n'est pas disponible, vous pouvez importer une photo ou une vidéo.",
    ...
    "Le paiement est actuellement en mode test : même avec une vraie carte, aucun montant n'est réellement débité. Il existe des formules Free/Basic/Standard/Pro ; pour une formule payante, connectez-vous puis appuyez sur « S'abonner » pour accéder au paiement.",
  ...
  "de": {
   ...
   "sug": [
    ...
    "Wird wirklich Geld abgebucht?",
    "Google-Anmeldung klappt nicht",
    "Werden meine Fotos gespeichert?"
   ],
   "a": [
    "Der Scan startet, wenn du im Bereich scan demo auf „Scannen und Design starten“ tippst. Erlaubst du den Kamerazugriff, kannst du ein Foto machen oder ein 5-Sekunden-Video aufnehmen; ohne Kamera kannst du auch eine Foto- oder Videodatei hochladen.",
    ...
    "Zahlungen laufen derzeit im Testmodus, daher wird auch bei Eingabe einer echten Karte kein Geld abgebucht. Es gibt die Pläne Free/Basic/Standard/Pro; für kostenpflichtige Pläne meldest du dich an und tippst auf „Abonnieren“, um zur Zahlung zu gelangen.",
  ...
  "ar": {
   ...
   "sug": [
    "كيف أقوم بالمسح؟",
    "هل سيُخصم المال فعلًا عند الدفع؟",
    "تسجيل الدخول عبر Google لا يعمل",
    "هل يتم حفظ صوري؟"
   ],
   "a": [
    "يبدأ المسح عند الضغط على زر \"امسح وابدأ التصميم\" في قسم scan demo. بعد السماح بالوصول إلى الكاميرا يمكنك التقاط صورة أو تسجيل فيديو مدته 5 ثوانٍ، وإذا تعذّر استخدام الكاميرا يمكنك رفع ملف صورة أو فيديو.",
    ...
    "الدفع متصل حاليًا بوضع تجريبي، لذلك لن يُخصم أي مال فعلي حتى لو أدخلت بطاقة حقيقية. تتوفر خطط Free/Basic/Standard/Pro، وللخطط المدفوعة سجّل الدخول ثم اضغط \"اشترك\" للانتقال إلى صفحة الدفع.",
    ...
    "لا تُحفظ بيانات الجسد (الصور، الطول) إلا إذا سجّلت الدخول ووافقت بنفسك على \"جمع بيانات الجسد وحفظها\". بدون الموافقة تُعرض على الشاشة فقط ولا تُحفظ على الخادم، ويمكنك في أي وقت تغيير موافقتك أو حذف البيانات المحفوظة من إعدادات الخصوصية.",
  ...
  "vi": {
   ...
   "sug": [
    "Quét cơ thể thế nào?",
    "Thanh toán có mất tiền thật không?",
    "Không đăng nhập Google được",
    "Ảnh của tôi có bị lưu không?"
   ],
   "a": [
    "Nhấn nút \"Quét và bắt đầu thiết kế\" trong mục scan demo để bắt đầu quét. Khi cho phép truy cập camera, bạn có thể chụp ảnh hoặc quay video 5 giây; nếu không dùng được camera, bạn có thể tải lên tệp ảnh hoặc video.",
    ...
    "Hiện thanh toán đang ở chế độ thử nghiệm, nên dù nhập thẻ thật cũng không bị trừ tiền. Có các gói Free/Basic/Standard/Pro; với gói trả phí, hãy đăng nhập rồi nhấn \"Đăng ký\" để chuyển đến trang thanh toán.",
    ...
    "Dữ liệu cơ thể (ảnh, chiều cao) chỉ được lưu khi bạn đăng nhập và tự đồng ý \"Thu thập & lưu trữ dữ liệu cơ thể\". Nếu không đồng ý, dữ liệu chỉ hiển thị trên màn hình và không lưu vào máy chủ; bạn có thể thay đổi sự đồng ý hoặc xóa dữ liệu đã lưu bất cứ lúc nào trong cài đặt quyền riêng tư.",
  ...
  "ne": {
   ...
   "sug": [
    "स्क्यान कसरी गर्ने?",
    "भुक्तानी गर्दा साँच्चै पैसा काटिन्छ?",
    "Google लगइन भएन",
    "मेरा फोटो सुरक्षित राखिन्छन्?"
   ],
   "a": [
    "scan demo खण्डको \"स्क्यान गरेर डिजाइन सुरु गर्नुहोस्\" बटन थिचेपछि स्क्यान सुरु हुन्छ। क्यामेरा अनुमति दिएपछि फोटो खिच्न वा ५ सेकेन्डको भिडियो रेकर्ड गर्न सकिन्छ; क्यामेरा चलाउन नसके फोटो वा भिडियो फाइल अपलोड गर्न पनि सकिन्छ।",
    ...
    "अहिले भुक्तानी परीक्षण मोडमा जोडिएको छ, त्यसैले वास्तविक कार्ड हाले पनि साँच्चै पैसा काटिँदैन। Free/Basic/Standard/Pro योजनाहरू छन्; शुल्क योजनाका लागि लगइन गरी \"सदस्यता लिनुहोस्\" थिचेपछि भुक्तानी पृष्ठमा जान्छ।",
    ...
    "शरीर डेटा (फोटो, उचाइ) लगइनपछि \"शरीर डेटा सङ्कलन·भण्डारण\" मा आफैं सहमति दिएमा मात्र सुरक्षित हुन्छ। सहमति नदिए स्क्रिनमा मात्र देखिन्छ, सर्भरमा सुरक्षित हुँदैन; गोपनीयता सेटिङमा जुनसुकै बेला सहमति बदल्न वा सुरक्षित डेटा मेटाउन सकिन्छ।",
  ...
  "th": {
   ...
   "sug": [
    "สแกนยังไง?",
    "ชำระเงินแล้วเสียเงินจริงไหม?",
    "เข้าสู่ระบบ Google ไม่ได้",
    "รูปของฉันถูกเก็บไว้ไหม?"
   ],
   "a": [
    "กดปุ่ม \"สแกนและเริ่มออกแบบ\" ในส่วน scan demo เพื่อเริ่มสแกน เมื่ออนุญาตให้ใช้กล้องแล้ว คุณสามารถถ่ายรูปหรืออัดวิดีโอ 5 วินาทีได้ ถ้าใช้กล้องไม่ได้ ก็อัปโหลดไฟล์รูปหรือวิดีโอแทนได้",
    ...
    "ตอนนี้การชำระเงินเชื่อมต่อแบบทดสอบ จึงไม่มีการตัดเงินจริงแม้จะใส่บัตรจริง มีแพ็กเกจ Free/Basic/Standard/Pro สำหรับแพ็กเกจแบบชำระเงิน ให้เข้าสู่ระบบแล้วกด \"สมัครสมาชิก\" เพื่อไปยังหน้าชำระเงิน",
    ...
    "ข้อมูลร่างกาย (รูป ส่วนสูง) จะถูกเก็บเฉพาะเมื่อคุณเข้าสู่ระบบและยินยอม \"การเก็บรวบรวมและจัดเก็บข้อมูลร่างกาย\" ด้วยตัวเองเท่านั้น หากไม่ยินยอม ข้อมูลจะแสดงบนหน้าจอเท่านั้นและไม่ถูกบันทึกบนเซิร์ฟเวอร์ และคุณเปลี่ยนความยินยอมหรือลบข้อมูลที่บันทึกไว้ได้ทุกเมื่อในการตั้งค่าความเป็นส่วนตัว",
  ...
  "fa": {
   ...
   "sug": [
    ...
    "با پرداخت واقعاً پول کم می‌شود؟",
    "ورود با گوگل کار نمی‌کند",
    "عکس‌هایم ذخیره می‌شوند؟"
   ],
   "a": [
    "با زدن دکمه «اسکن و شروع طراحی» در بخش scan demo اسکن شروع می‌شود. با اجازه دادن به دوربین می‌توانی عکس بگیری یا ویدیوی ۵ ثانیه‌ای ضبط کنی؛ اگر دوربین در دسترس نیست، می‌توانی فایل عکس یا ویدیو بارگذاری کنی.",
    ...
    "فعلاً پرداخت در حالت آزمایشی متصل است، بنابراین حتی با کارت واقعی هم پولی کسر نمی‌شود. پلن‌های Free/Basic/Standard/Pro وجود دارد؛ برای پلن‌های پولی وارد شو و «اشتراک» را بزن تا به صفحه پرداخت بروی.",
    ...
    "داده‌های بدن (عکس، قد) فقط وقتی ذخیره می‌شوند که وارد شده باشی و خودت با «جمع‌آوری و نگهداری داده‌های بدن» موافقت کرده باشی. بدون موافقت فقط روی صفحه نمایش داده می‌شوند و در سرور ذخیره نمی‌شوند، و هر زمان می‌توانی از تنظیمات حریم خصوصی رضایتت را تغییر دهی یا داده‌های ذخیره‌شده را حذف کنی.",
  ...
  "sv": {
   ...
   "sug": [
    "Hur skannar jag?",
    "Dras det verkligen pengar?",
    "Google-inloggningen fungerar inte",
    "Sparas mina foton?"
   ],
   "a": [
    "Skanningen startar när du trycker på knappen ”Skanna och börja designa” i avsnittet scan demo. Om du tillåter kameran kan du ta ett foto eller spela in en 5-sekundersvideo; kan du inte använda kameran går det bra att ladda upp en foto- eller videofil.",
    ...
    "Betalningen är just nu kopplad i testläge, så inga riktiga pengar dras även om du anger ett riktigt kort. Det finns planerna Free/Basic/Standard/Pro; för betalda planer loggar du in och trycker på ”Prenumerera” för att komma till betalningen.",
    ...
    "Kroppsdata (foton, längd) sparas bara om du loggar in och själv godkänner ”Insamling och lagring av kroppsdata”. Utan godkännande visas de bara på skärmen och sparas inte på servern, och du kan när som helst ändra ditt samtycke eller radera sparad data i integritetsinställningarna.",
  ...
  "bn": {
   ...
   "sug": [
    "স্ক্যান কীভাবে করব?",
    "পেমেন্ট করলে সত্যিই টাকা কাটবে?",
    "Google লগইন হচ্ছে না",
    "আমার ছবি কি সংরক্ষিত হয়?"
   ],
   "a": [
    "scan demo অংশে \"স্ক্যান করে ডিজাইন শুরু করুন\" বোতাম চাপলে স্ক্যান শুরু হয়। ক্যামেরার অনুমতি দিলে ছবি তুলতে বা ৫ সেকেন্ডের ভিডিও রেকর্ড করতে পারবেন; ক্যামেরা ব্যবহার করতে না পারলে ছবি বা ভিডিও ফাইল আপলোডও করতে পারেন।",
    ...
    "এখন পেমেন্ট টেস্ট মোডে যুক্ত আছে, তাই আসল কার্ড দিলেও সত্যি টাকা কাটবে না। Free/Basic/Standard/Pro প্ল্যান আছে; পেইড প্ল্যানের জন্য লগইন করে \"সাবস্ক্রাইব করুন\" চাপলে পেমেন্ট পেজে যাবেন।",
    ...
    "শরীরের ডেটা (ছবি, উচ্চতা) কেবল লগইন করে নিজে \"শরীরের ডেটা সংগ্রহ ও সংরক্ষণ\"-এ সম্মতি দিলেই সংরক্ষিত হয়। সম্মতি না দিলে শুধু স্ক্রিনে দেখা যায়, সার্ভারে সংরক্ষিত হয় না; গোপনীয়তা সেটিংসে যেকোনো সময় সম্মতি বদলাতে বা সংরক্ষিত ডেটা মুছতে পারবেন।",
  ...
  "id": {
   ...
   "sug": [
    ...
    "Apakah uang benar-benar terpotong?",
    "Login Google tidak berhasil",
    "Apakah foto saya disimpan?"
   ],
   "a": [
    "Pemindaian dimulai dengan menekan tombol \"Pindai dan mulai mendesain\" di bagian scan demo. Setelah mengizinkan akses kamera, kamu bisa memotret atau merekam video 5 detik; jika kamera tidak bisa dipakai, kamu juga bisa mengunggah file foto atau video.",
    ...
    "Saat ini pembayaran terhubung dalam mode uji coba, jadi tidak ada uang yang benar-benar terpotong meskipun kamu memasukkan kartu asli. Tersedia paket Free/Basic/Standard/Pro; untuk paket berbayar, masuk lalu ketuk \"Berlangganan\" untuk menuju halaman pembayaran.",
    ...
    "Data tubuh (foto, tinggi) hanya disimpan jika kamu login dan menyetujui sendiri \"Pengumpulan & penyimpanan data tubuh\". Jika tidak setuju, data hanya tampil di layar dan tidak disimpan di server, dan kamu bisa mengubah persetujuan atau menghapus data tersimpan kapan saja di pengaturan privasi.",
  ...
  "tr": {
   ...
   "sug": [
    ...
    "Ödeme yapınca gerçekten para çekilir mi?",
    "Google ile giriş yapamıyorum",
    "Fotoğraflarım saklanıyor mu?"
   ],
   "a": [
    "Tarama, scan demo bölümündeki \"Tara ve tasarıma başla\" düğmesine basınca başlar. Kamera iznini verirsen fotoğraf çekebilir veya 5 saniyelik video kaydedebilirsin; kamerayı kullanamıyorsan fotoğraf ya da video dosyası da yükleyebilirsin.",
    ...
    "Ödemeler şu an test modunda bağlı olduğu için gerçek kart girsen bile gerçekten para çekilmez. Free/Basic/Standard/Pro planları var; ücretli planlar için giriş yapıp \"Abone ol\"a dokunduğunda ödeme sayfasına gidersin.",
    ...
    "Beden verileri (fotoğraf, boy) yalnızca giriş yapıp \"Beden verisi toplama ve saklama\"ya kendin onay verirsen saklanır. Onay vermezsen yalnızca ekranda gösterilir, sunucuya kaydedilmez; gizlilik ayarlarından onayını istediğin zaman değiştirebilir veya kayıtlı verileri silebilirsin.",
  ...
  "nl": {
   ...
   "sug": [
    ...
    "Wordt er echt geld afgeschreven?",
    "Inloggen met Google lukt niet",
    "Worden mijn foto’s bewaard?"
   ],
   "a": [
    "Het scannen begint wanneer je in het onderdeel scan demo op \"Scannen en beginnen met ontwerpen\" tikt. Als je cameratoegang geeft, kun je een foto maken of een video van 5 seconden opnemen; kun je de camera niet gebruiken, dan kun je ook een foto- of videobestand uploaden.",
    ...
    "Betalingen zijn nu in testmodus gekoppeld, dus zelfs met een echte kaart wordt er geen echt geld afgeschreven. Er zijn Free/Basic/Standard/Pro-abonnementen; voor betaalde abonnementen log je in en tik je op \"Abonneren\" om naar de betaalpagina te gaan.",
  ...
  "hi": {
   ...
   "sug": [
    "स्कैन कैसे करें?",
    "क्या भुगतान करने पर सच में पैसे कटेंगे?",
    "Google लॉगिन नहीं हो रहा",
    "क्या मेरी फ़ोटो सेव होती है?"
   ],
   "a": [
    "scan demo सेक्शन में \"स्कैन करें और डिज़ाइन शुरू करें\" बटन दबाने से स्कैन शुरू होता है। कैमरा की अनुमति देने पर आप फ़ोटो ले सकते हैं या 5 सेकंड का वीडियो रिकॉर्ड कर सकते हैं; कैमरा इस्तेमाल न हो सके तो फ़ोटो या वीडियो फ़ाइल अपलोड भी कर सकते हैं।",
    ...
    "अभी भुगतान टेस्ट मोड में जुड़ा है, इसलिए असली कार्ड डालने पर भी सच में पैसे नहीं कटते। Free/Basic/Standard/Pro प्लान हैं; सशुल्क प्लान के लिए लॉगिन करके \"सदस्यता लें\" दबाने पर भुगतान पेज खुलता है।",
    ...
    "शरीर का डेटा (फ़ोटो, ऊंचाई) तभी सेव होता है जब आप लॉगिन करके खुद \"शरीर डेटा संग्रह और भंडारण\" के लिए सहमति देते हैं। सहमति न देने पर यह सिर्फ़ स्क्रीन पर दिखता है और सर्वर पर सेव नहीं होता; गोपनीयता सेटिंग में कभी भी सहमति बदल सकते हैं या सेव डेटा मिटा सकते हैं।",
  ...
  "pt": {
   ...
   "sug": [
    ...
    "Vou ser cobrado de verdade?",
    "O login com Google não funciona",
    "Minhas fotos ficam salvas?"
   ],
   "a": [
    "O escaneamento começa ao tocar no botão \"Escanear e começar a criar\" na seção scan demo. Ao permitir o acesso à câmera, você pode tirar uma foto ou gravar um vídeo de 5 segundos; se não puder usar a câmera, também pode enviar um arquivo de foto ou vídeo.",
    ...
    "No momento o pagamento está em modo de teste, então nenhum dinheiro é cobrado de verdade, mesmo com um cartão real. Há os planos Free/Basic/Standard/Pro; para planos pagos, faça login e toque em \"Assinar\" para ir ao pagamento.",
  ...
  "it": {
   ...
   "sug": [
    ...
    "Mi verranno davvero addebitati soldi?",
    "Non riesco ad accedere con Google",
    "Le mie foto vengono salvate?"
   ],
   "a": [
    "La scansione parte toccando il pulsante \"Scansiona e inizia a progettare\" nella sezione scan demo. Consentendo l’accesso alla fotocamera puoi scattare una foto o registrare un video di 5 secondi; se non puoi usare la fotocamera, puoi anche caricare un file foto o video.",
    ...
    "Al momento i pagamenti sono collegati in modalità di test, quindi anche inserendo una carta vera non viene addebitato alcun importo. Ci sono i piani Free/Basic/Standard/Pro; per i piani a pagamento accedi e tocca \"Abbonati\" per andare al pagamento.",
  ...
  "es": {
   ...
   "sug": [
    ...
    "¿De verdad me cobrarán?",
    "No puedo iniciar sesión con Google",
    "¿Se guardan mis fotos?"
   ],
   "a": [
    "El escaneo empieza al tocar el botón \"Escanear y empezar a diseñar\" en la sección scan demo. Si permites el acceso a la cámara, puedes hacer una foto o grabar un vídeo de 5 segundos; si no puedes usar la cámara, también puedes subir un archivo de foto o vídeo.",
    ...
    "Ahora mismo los pagos están conectados en modo de prueba, así que aunque introduzcas una tarjeta real no se cobra dinero de verdad. Hay planes Free/Basic/Standard/Pro; para los de pago, inicia sesión y toca \"Suscribirse\" para ir al pago.",
  ...
  "pl": {
   ...
   "sug": [
    ...
    "Czy naprawdę zostaną pobrane pieniądze?",
    "Logowanie przez Google nie działa",
    "Czy moje zdjęcia są zapisywane?"
   ],
   "a": [
    "Skanowanie zaczyna się po naciśnięciu przycisku „Skanuj i zacznij projektować” w sekcji scan demo. Po zezwoleniu na dostęp do kamery możesz zrobić zdjęcie lub nagrać 5-sekundowy film; jeśli nie możesz użyć kamery, możesz też przesłać plik ze zdjęciem lub filmem.",
    ...
    "Płatności są obecnie podłączone w trybie testowym, więc nawet po podaniu prawdziwej karty nie zostaną pobrane prawdziwe pieniądze. Dostępne są plany Free/Basic/Standard/Pro; w przypadku płatnych planów zaloguj się i dotknij „Subskrybuj”, aby przejść do płatności.",
 ...
 "kw": [
  ...
  // 추천 질문 4개가 가리키는 답변 번호 (0:스캔, 2:결제, 1:로그인, 7:개인정보)
