...
(function initSupportChat(){
 ...
 "ui": {
  "ko": {
   ...
   "sub": "자주 묻는 질문에 바로 답해드립니다",
   "ph": "궁금한 걸 물어보세요 (예: 결제, 로그인, 스캔...)",
   "send": "전송",
   "close": "닫기",
   "hello": "안녕하세요! UNEXPOSED에 대해 궁금한 걸 물어보세요. 스캔, 로그인, 결제, 원단, 옷장 등 무엇이든 답해 드리겠습니다. (규칙 기반 FAQ 챗봇입니다)",
   "fallback": "죄송합니다, 정확히 이해하지 못했습니다. 아래 추천 질문 중 하나를 눌러보시거나, 스캔·로그인·결제·원단·옷장 중 어떤 부분이 궁금한지 다시 말씀해 주시겠습니까?",
   "sug": [
    "스캔은 어떻게 합니다?",
    "요금제가 어떻게 되나요?",
    "구글 로그인이 안 됩니다",
   ...
   "a": [
    "스캔은 \"scan demo\" 섹션의 \"3D로 꾸미기 시작\" 또는 \"2D로 꾸미기 시작\" 버튼을 누르면 시작됩니다. 카메라 권한을 허용하면 사진 촬영이나 5초 동영상 녹화를 할 수 있고, 카메라를 쓸 수 없으면 사진·동영상 파일을 업로드해도 됩니다.",
    "Google 계정으로 로그인해서 유료 플랜 구독이나 결제를 할 수 있습니다. 카카오톡·클로드 앱 같은 인앱 브라우저에서는 구글 보안 정책상 로그인이 막혀 있어서, 화면 위 배너의 \"외부 브라우저로 열기\"를 눌러서 크롬·사파리로 열어주세요.",
    "요금제는 월간 결제 9,900원, 연간 결제 109,800원 두 가지입니다. 연간 결제는 월간으로 12개월 내는 금액(118,800원)보다 7.6% 저렴합니다. 요금제 섹션에서 \"구독하기\"를 누르면 결제 페이지로 이동합니다.",
    "원단 등급(베이직/프리미엄/스페셜), 디테일 옵션(자수·특수재단), 완성 형태(패턴 PDF/완제품 배송)를 골라서 실시간으로 예상 제작 견적을 확인할 수 있습니다. \"기타(직접 요청)\"를 선택하면 원하는 원단·디자인을 자유롭게 적을 수도 있습니다.",
    "스캔 화면 안 \"옷장 & 꾸미기\"에서 기본 제공 아이템을 둘러보거나, 연령대·상황에 맞춰 추천받거나, 직접 만든 옷·장신구(.glb 파일)를 올려서 마네킹에 입혀볼 수 있습니다.",
    "키(cm)를 입력하고 \"아바타 생성하기\"를 누르면 3D 마네킹 크기가 그 비율에 맞게 조정됩니다. 마우스나 손가락으로 드래그하면 360도로 돌려볼 수 있습니다.",
    "지금은 데모 버전이라 실제 제작·배송은 아직 연결되어 있지 않습니다. 정식 서비스에서는 완성한 디자인을 파트너 제작사에 도면(PDF)으로 넘기거나, 완제품으로 배송받는 옵션을 고를 수 있게 될 예정입니다.",
    "신체 데이터(사진·키)는 로그인 후 \"신체 데이터 수집·보관\"에 직접 동의한 경우에만 저장됩니다. 동의하지 않으면 화면에만 보이고 서버에는 저장되지 않고, 언제든 왼쪽 상단 메뉴의 \"신체 데이터 동의 설정\"에서 동의를 바꾸거나 저장된 데이터를 삭제할 수 있습니다.",
    "UNEXPOSED는 PentaCorp(펜타콘) 팀이 만든 서비스입니다. 지금은 데모 단계라, 더 궁금한 점은 이 채팅으로 남겨주시면 확인 후 도와드리겠습니다."
   ]
  },
  "en": {
